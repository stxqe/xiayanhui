...
function buttonRel(href, permission, pers){
	if(permission != ""){
		if ($.inArray(permission, pers) < 0) {
			return "";
		}
	...
	var btn = $("<button class='layui-btn layui-btn-xs' title='详细信息' onclick='window.location=\"" + href +"\"'><i class='layui-icon'>&#xe64c;</i>详细信息</button>");
	return btn.prop("outerHTML");
}
